...
Durch die Entwicklung und Evaluation des Prototyps wird aufgezeigt, wie die Modellkonformität 
für die anschließende modellbasierte automatische Mengenermittlung verbessert werden kann. 
...
\begin{itemize}
    \item \textbf{Fachliche Datenhoheit:} 
    ...
    Plausibilitätsprüfung der zugewiesenen Werte ist nicht Gegenstand der Untersuchung.
    ...
    Der Fokus dieser Arbeit liegt primär auf der technischen Schnittstelle zwischen 
    ...
    Eine vollumfängliche Prozessprüfung der kalkulatorischen Genauigkeit der Mengenermittlung 
    findet nicht statt.    
    \item \textbf{Software-Fokus:} 
    Die Umsetzung erfolgt prototypisch auf Basis von Open-Source Technologien (IfcOpenShell). 
    Eine Integration als Plug-in in kommerzielle Autorensoftware (z. B. Revit oder Archicad)
    ...
    der im österreichischen Raum üblichen Austauschstandards.
\end{itemize}

\subsection{Grenzen und weitere Forschung}
Aufgrund der Wahl einer technischen Evaluation (\textit{Technical Risk \& Efficacy}) ist 
die Generalisierbarkeit auf die menschliche Interaktion eingeschränkt \cite{venable2016feds}. 
Zukünftige Forschungsarbeiten könnten darauf aufbauen, indem KI-gestützte Ansätze zur 
automatisierten Zuordnung von \gls{ids}-Anforderungen integriert werden oder die Skalierbarkeit 
des Ansatzes auf Großprojekte und weitere Lebenszyklusphasen wie das Facility Management 
untersucht wird. Ergänzend bleibt festzuhalten, dass die Wirksamkeit des entwickelten Artefakts 
in der Praxis eng an die Verbreitung von \gls{ids}-basierten Workflows und die Qualität der 
Modellgeometrien geknüpft ist.
